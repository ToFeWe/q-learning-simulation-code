#!/bin/bash
#PBS -l select=1:ncpus=1:mem=160MB:arch=skylake
#PBS -l walltime=00:10:00
#PBS -A "AlgColl"
#PBS -r y
#PBS -o pbs_output/o_files/test/job_array_index_[^array_index^].OU
#PBS -e pbs_output/e_files/test/job_array_index_[^array_index^].ER
...
eval 'python run_mc_simulation.py parameter_test_base parameter_test_cases '$PBS_ARRAY_INDEX | tee -a ${LOGFILE}
