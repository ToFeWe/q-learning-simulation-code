...
#PBS -A "AlgColl"
#PBS -r y
#PBS -o pbs_output/o_files/2_agents/super_stars/job_array_index_[^array_index^].OU
#PBS -e pbs_output/e_files/2_agents/super_stars/job_array_index_[^array_index^].ER
...
eval 'python run_super_star_simulation.py parameter_super_star_2_agent '$PBS_ARRAY_INDEX | tee -a ${LOGFILE}
