...
#PBS -e pbs_output/e_files/3_agents/grid_search/job_array_index_[^array_index^].ER
...
eval 'python run_mc_simulation.py parameter_3_agent_base parameter_3_agent_cases '$PBS_ARRAY_INDEX | tee -a ${LOGFILE}
